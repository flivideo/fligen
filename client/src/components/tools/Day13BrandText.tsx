        ...
        <div className="w-96 overflow-y-auto border-r border-slate-700 p-4">
          <div className="space-y-4">
                ...
                {config.segments.map((segment, idx) => (
                  <div key={segment.id} className="flex gap-1 items-center text-xs">
                    ...
                    <div className="flex gap-1">
                      <select
                        value={
                          Object.keys(template.colors).includes(segment.color)
                            ? segment.color
                            : 'custom'
                        }
                        onChange={(e) => {
                ...
                {config.glowEnabled && (
                  <div className="ml-5 space-y-1">
                    <div className="flex gap-1">
                      <select
                        value={
                          Object.keys(template.colors).includes(config.glowColor)
                            ? config.glowColor
                            : 'custom'
                        }
                        onChange={(e) => {
                      ...
                      <input
                        ...
                        value={
                          Object.keys(template.colors).includes(config.glowColor)
                            ? template.colors[config.glowColor]
                            : config.glowColor
                        }
            ...
            <div className="border-t border-slate-700 pt-2">
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => {
                    updateConfig({
                      canvasSize: { ...config.canvasSize, width: Number(e.target.value) },
                    });
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    updateConfig({
                      canvasSize: { ...config.canvasSize, height: Number(e.target.value) },
                    });
                    setCanvasPreset('custom');
                  }}
                  className="w-full accent-blue-500"
            ...
            <div className="border-t border-slate-700 pt-2">
              ...
              {showSuccess && <p className="text-green-400 text-xs mt-1">✓ Success!</p>}
